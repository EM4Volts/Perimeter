...
def perimeter_make_rpak( context, material_collection ): #legacy repak map function, kept incase legacy support is needed. dont touch
    ...
    #get the material name from the material_collection item and split then use te last item in the list as the material name
    mat_name = material_collection.blender_material.name.split("/")[-1]
